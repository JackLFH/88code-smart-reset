 ...
 * 创建消息
 */
export declare function createMessage<T extends MessageType, P extends Record<string, unknown>>(type: T, payload: P, source: MessageSource, destination: MessageDestination): Message<T, P>;
/**
 * 创建成功响应
 */
export declare function createSuccessResponse<T>(data: T): MessageResponse<T>;
/**
 * 创建错误响应
 */
export declare function createErrorResponse(code: string, message: string, details?: Record<string, unknown>): MessageResponse;
