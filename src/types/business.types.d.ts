 ...
 * 检查重置结果是否成功
 */
export declare function isResetSuccess(result: ResetResult): boolean;
/**
 * 检查重置结果是否部分成功
 */
export declare function isResetPartial(result: ResetResult): boolean;
/**
 * 检查今天是否需要执行重置
 */
export declare function shouldExecuteReset(state: ExecutionState, isFirstReset: boolean): boolean;
